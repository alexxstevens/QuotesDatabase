...
//username parameters
  if(isset($_POST['username'])) {
    ...
    $error_login_username = 'Username is invalid. Username must be at least 5 characters long. Please re-enter your username.';
   }}
...
//password parameters
    ...
    $password = filter_input(INPUT_POST, 'password');
      ...
      $error_password = 'Password is invalid. Password must be at least 5 characters long. Please re-enter your username.';
   }}
